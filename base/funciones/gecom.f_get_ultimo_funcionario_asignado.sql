...
BEGIN
	...
	***********************************/
		...
		begin
            ...
            v_id_funcionario = gecom.f_get_ultimo_funcionario_asignado(v_id_numero_celular, v_parametros.id_periodo);
            
            if (v_id_funcionario is null) then
            	raise exception 'El nro de celular : %, no tiene un funcionado asignado para el periodo.', v_parametros.numero;
            end if;
