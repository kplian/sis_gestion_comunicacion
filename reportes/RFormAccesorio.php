...
class RFormAccesorio extends  ReportePDF {
    var $cabecera;
    var $detalleCbte;
    var $ancho_hoja;
    var $gerencia;
    ...
    function datosHeader ( $detalle) {
        ...
        $this->conformidad_funcionario = '';
        $this->conformidad_asignador = '';
        $this->conformidad_fecha = '';
    ...
    function Header() {
        ...
        if ($this->datos_estructura == 'asignacion'){
            $this->datos_estructura = "ASIGNACION DE ACCESORIO";
            $this->num_form = "5-R-506/0";
            ...
            $this->datos_mensaje = "En caso de que el accesorio presente fallos en su funcionamiento, debe reportarse a Departamento de Tecnologías de Información, via mail o sistema de soporte de Ende Transmision S.A.";

            $this->conformidad_funcionario = 'CONFORMIDAD DE RECEPCIÓN';
            $this->conformidad_asignador = 'CONFORMIDAD DE ASIGNACIÓN';
            $this->conformidad_fecha = 'FECHA DE ENTREGA';
        }else if($this->datos_estructura == 'devolucion'){
            $this->datos_estructura = "DEVOLUCIÓN DE ACCESORIO";
            $this->num_form = "5-R-507/0";
            $this->datos_mensaje_1 = "";
            $this->datos_mensaje = "A partir de la fecha de devolución, el usuario se deslinda de las responsabilidades sobre el accesorio";

            $this->conformidad_funcionario = 'CONFORMIDAD DE DEVOLUCIÓN';
            $this->conformidad_asignador = 'CONFORMIDAD DE RECEPCIÓN';
            $this->conformidad_fecha = 'FECHA DE RECEPCIÓN';
        }
    ...
    function generarReporte1() {
        ...
        //adiciona glosa
        ob_start();
        include(dirname(__FILE__).'/../reportes/accesorio/cuerpo.php');
        $content = ob_get_clean();

        ob_start();
        include(dirname(__FILE__).'/../reportes/accesorio/detalle.php');
